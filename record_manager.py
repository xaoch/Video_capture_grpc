...
class RecordManager:
    """
    Controla la grabacion de audio y video y el estado de ambos.
    ...
    def __init__(self, init_devices=True, stop_callback=None, on_error=None):
        ...
        self.video_recorder = self.audio_recorder = None
        if init_devices:
    ...
    def get_device_status(self, device="all"):
        ...
        return 0
        #return {"video": self.video_record_status,
        #        "audio": self.audio_record_status}
